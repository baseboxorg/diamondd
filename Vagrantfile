...
config.vm.box = "boxcutter/ubuntu1404"
  ...
  config.vm.hostname = 'dockerun.local'
    ...
    config.vm.network "forwarded_port", guest: 17771, host: 17771, auto_correct: true
    config.vm.network "forwarded_port", guest: 17772, host: 17772, auto_correct: true
